...
class LlamaAttention(nn.Module):
    ...
    def forward(
        ...
        # print("query_states1",query_states.dtype)
        # print("key_states1",key_states.dtype)
        ...
        past_key_value = None
        # print("key_states2",key_states.dtype)
...
class LlamaModel(LlamaPreTrainedModel):
    ...
    def forward(
        ...
        # print(".weight.device",self.embed_tokens.weight.device)
        # print("self.embed_tokens",self.embed_tokens.device)
        ...
        for idx, decoder_layer in enumerate(self.layers):
            ...
            if ngl != -1 and idx == ngl :
                ...
                # output_attentions = output_attentions.to(device="cpu")
                # use_cache = use_cache.to(device="cpu")
