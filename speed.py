...
tokenizer=AutoTokenizer.from_pretrained("/home/zlb/model/llama-2-7B-chat-hf")
jsonl_file = "ess-llama-2-chat-7b_quantize_eagle_7_4_10-temperature-0.0.jsonl"
jsonl_file_base = "ess-llama-2-chat-7b-baseline_quantize-temperature-0.0.jsonl"
data = []
