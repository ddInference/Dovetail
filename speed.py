...
tokenizer=AutoTokenizer.from_pretrained("/home/lzq/model/Llama-2-7b-chat-hf/")
jsonl_file = "./partial-offload+SD/output_16-7-10-temperature-0.0.jsonl"
jsonl_file_base = "./CPU-only/output_16-7-10-temperature-0.0.jsonl"
